...
const double neckOffsetZ = .0527;//.0182 + .0632 ;//.026+.0505;//OP, calculated from spec
const double neckOffsetX = .00356;//.0129;//.013;//OP, calculated from spec
const double shoulderOffsetX = .0225;//.0079;//.013;//OP, calculated from spec
const double shoulderOffsetY = .1141;//.082; //op, spec 
const double shoulderOffsetZ = .018;//.036;//.026; //OP, calculated from spec
const double handOffsetX = .058;
const double handOffsetZ = .0159;
const double upperArmLength = .1476;//.1296;//.060;  //OP, spec
const double lowerArmLength = .114;//.1689;//.129;  //OP, spec

const double hipOffsetY = .0569;//.035;//.037;    //OP, measured
//const double hipOffsetZ = .050;    //OP, Guesswork
const double hipOffsetZ = .2258;//.1725;//.096;    //OP, Calculated from spec
const double hipOffsetX = .001;//.0060;//.008;    //OP, Calculated from spec
const double thighLength = .131;//.0930;  //OP, spec
const double tibiaLength = .131;//.0930;  //OP, spec
const double footHeight = .045;//.058;//.075;//.0335;   //OP, spec
