...
kick.def["slowkickForwardLeft"]={
   supportLeg = 1, --Right support
   def = {
     {1, 0.6, {-0.01 ,-0.053,0} , 0.300          }, --COM slide
     {2, 0.4, {-0.01 ,-0.058,0} , {-0.03,-0.02,0}, 0.02 , 0}, --Lifting
     {2, 0.4, {-0.05 ,-0.058,0} , {-0.03,0,0}, 0.06 , 40*math.pi/180, 10*math.pi/180},--Lifti$
     {4, 0.1, {-0.06 ,-0.058,0} , { 0.12,0,0},  0.03 , 0*math.pi/180, 0*math.pi/180}, --Kicki$
     {2, 0.38,{-0.085,-0.058,0} , {-0.065,0.015,0}, 0.002, -0.1 }, --Landing
...
kick.def["slowkickForwardRight"]={
  supportLeg = 0,
  def = {
    {1, 0.6, {-0.01 ,0.058,0} ,0.300                       }, --COM slide
    {3, 0.4, {-0.01 ,0.061,0} , {-0.03, 0.02, 0}, 0.02 , 0},
    {3, 0.4, {-0.05 ,0.061,0} , {-0.03, 0.0, 0}, 0.06 , 40*math.pi/180},
    {5, 0.1, {-0.06 ,0.061,0} , { 0.12, 0, 0},  0.03 , 0*math.pi/180},--Kicking
    {3, 0.38,{-0.085 ,0.061,0} , {-0.065,-0.015,0}, 0.005, -0.1 }, --Landing
    {1, 0.8, {-0.01, 0.02, 0}},--COM slide
    {6, 1, {-0.005, 0.01, 0}},--Stabilize
  },
};
