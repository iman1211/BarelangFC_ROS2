...
kick.def["kickForwardLeft"]={
   ...
   def = {
     ...
     {2, 0.1, { -0.03, -0.058, 0 }, { -0.06,  0,0 }, 0.10, 40*math.pi/180 }, 	--Lifting
     {4, 0.2, { -0.03, -0.059, 0 }, {  0.30,  0,0 }, 0.07,  0*math.pi/180 }, 	--Kicking
     {2, 0.4, { -0.01, -0.057, 0 }, { -0.18,  0.01, 0 },    0, 0 },		--Landing
     {1, 0.7, { -0.00, -0.020, 0 } },						--COM slide
     {6, 0.9, {  0.00, -0.010, 0 } },						--Stabilize
   },
};
...
kick.def["kickForwardRight"]={
  ...
  def = {
    {1, 0.6, {-0.01, 0.050, 0}, 0.303	}, --COM slide
    {3, 0.3, {-0.01, 0.053, 0}, {-0.06, 0.02, 0}, 0.05 , 0},
    {3, 0.1, {-0.03, 0.053, 0}, {-0.06, 0.00, 0}, 0.10 , 40*math.pi/180}, 
    {5, 0.2, {-0.03, 0.053, 0}, { 0.30, 0,00},  0.07 , 0*math.pi/180},--Kicking
    {3, 0.4, {-0.01, 0.053, 0}, {-0.18,-0.010,0}, 0, 0 }, --Landing
    {1, 0.4, {-0.00, 0.020, 0}	},--COM slide
...
kick.def["slowkickForwardLeft"]={
   supportLeg = 1, --Right support
   def = {
     {1, 0.7, {-0.01,-0.054,0} , 0.303          }, --COM slide
     {2, 0.4, {-0.01,-0.059,0} , {-0.06,-0.02,0}, 0.05 , 0}, --Lifting
     {2, 0.3, {-0.03, -0.059,0} , {-0.06,0,0}, 0.10 , 40*math.pi/180},--Lifting
     {4, 0.2, {-0.03,-0.059,0} , {0.30,0,0},  0.07 , 0*math.pi/180}, --Kicking
     {2, 0.25, {-0.55,-0.059,0} , {-0.18,0.010,0}, 0, 0.01 }, --Landing
--     {2, 0.35, {-0.01,-0.059,0} , {0.00,0.0,0}, 0, 0 }, --Landing
     {1, 0.6, {-0.00,-0.02, 0}},--COM slide
     {6, 0.6, {0.000, -0.01, 0}},--Stabilize
   },
};
...
kick.def["slowkickForwardRight"]={
  supportLeg = 0,
  def = {
    {1, 0.7, {-0.01 ,0.048,0},0.303}, --COM slide
    {3, 0.4, {-0.01 ,0.053,0} , {-0.06, 0.02, 0}, 0.05 , 0},
    {3, 0.3, {-0.03 ,0.053,0} , {-0.06, 0.0, 0}, 0.10 , 40*math.pi/180},
    {5, 0.2, {-0.03 ,0.053,0} , {0.30, 0, 0},  0.07 , 0*math.pi/180},--Kicking
    {3, 0.25, {-0.18 ,0.053,0} , {-0.18,-0.010,0}, 0, 0.02 }, --Landing
--    {3, 0.35, {-0.01 ,0.053,0} , {0.00,0.00,0}, 0, 0 }, --Landing
...
kick.def["slowkickForwardLeft"]={
   supportLeg = 1, --Right support
   def = {
     {1, 0.7, {-0.01 ,-0.053,0} , 0.300          }, --COM slide
     {2, 0.4, {-0.01 ,-0.058,0} , {-0.06,-0.02,0}, 0.05 , 0}, --Lifting
     {2, 0.3, {-0.05 ,-0.058,0} , {-0.06,0,0}, 0.10 , 40*math.pi/180, 10*math.pi/180},--Lifti$
     {4, 0.1, {-0.06 ,-0.058,0} , { 0.28,0,0},  0.08 , 0*math.pi/180, 0*math.pi/180}, --Kicki$
     {2, 0.38,{-0.085,-0.058,0} , {-0.17,0.015,0}, 0, -0.1 }, --Landing
...
kick.def["slowkickForwardRight"]={
  supportLeg = 0,
  def = {
    {1, 0.7, {-0.01 ,0.058,0} ,0.300                       }, --COM slide
    {3, 0.4, {-0.01 ,0.061,0} , {-0.06, 0.02, 0}, 0.05 , 0},
    {3, 0.3, {-0.05 ,0.061,0} , {-0.06, 0.0, 0}, 0.10 , 40*math.pi/180},
    {5, 0.1, {-0.06 ,0.061,0} , {0.28, 0, 0},  0.08 , 0*math.pi/180},--Kicking
    {3, 0.38,{-0.085 ,0.061,0} , {-0.17,-0.015,0}, 0, -0.1 }, --Landing
    {1, 0.8, {-0.01, 0.02, 0}},--COM slide
    {6, 1, {-0.005, 0.01, 0}},--Stabilize
  },
};
...
kick.def["kickOffLeftSyntethic"]={
  ...
  def = {
     {1, 0.7, {-0.01 ,-0.053,0} , 0.300          }, --COM slide
     {2, 0.5, {-0.01 ,-0.058,0} , {-0.06,-0.02,0}, 0.05 , 0}, --Lifting
     {2, 0.5, {-0.05 ,-0.058,0} , {-0.06,0,0}, 0.10 , 40*math.pi/180, 10*math.pi/180},--Lifti$
     {4, 0.1, {-0.06 ,-0.058,0} , { 0.25,0,0},  0.08 , 0*math.pi/180, 0*math.pi/180}, --Kicki$
     {2, 0.35,{-0.085,-0.058,0} , {-0.13,0.015,0}, 0, -0.1 }, --Landing
     {1, 0.8, {-0.01, -0.02, 0}},--COM slide
     {6, 1, {-0.005, -0.01, 0}},--Stabilize
   },
};
...
kick.def["kickOffRightSyntethic"]={
  ...
  def = {
    {1, 0.7, {-0.01 ,0.058,0} , 0.300            }, --COM slide
    {3, 0.5, {-0.01 ,0.061,0} , {-0.06, 0.02, 0}, 0.05 , 0},
    {3, 0.5, {-0.05 ,0.061,0} , {-0.06, 0.0, 0}, 0.10 , 40*math.pi/180},
    {5, 0.1, {-0.06 ,0.061,0} , {0.25, 0, 0},  0.08 , 0*math.pi/180},--Kicking
    {3, 0.35,{-0.085 ,0.061,0} , {-0.13,-0.015,0}, 0, -0.1 }, --Landing
    {1, 0.8, {-0.01, 0.02, 0}},--COM slide
    {6, 1, {0.000, 0.01, 0}},--Stabilize
--    {1, 0.6, {-0.00, 0.02, 0}},--COM slide
--    {6, 0.65, {0.000, 0.01, 0}},--Stabilize
  },
}
...
kick.def["kickOffRightSyntethic"]={
  supportLeg = 0,
  def = {
    {1, 0.6, {-0.02 ,0.040,0},0.303}, --COM slide
    {3, 0.2, {-0.02 ,0.040,0} , {-0.02, 0.02, 0}, 0.01 , 0},
    {3, 0.1, {-0.03 ,0.040,0} , {-0.02, 0, 0}, 0.04 , 20*math.pi/180},
    {5, 0.2, {-0.03 ,0.040,0} , { 0.25, 0, 0},  0.02 , 0*math.pi/180},--Kicking
    {3, 0.2, {-0.02 ,0.040,0} , {-0.11,-0.005,0}, 0, 0 }, --Landing
    {3, 0.2, {-0.02 ,0.040,0} , {-0.11,-0.005,0}, 0, 0 }, --Landing
    {1, 0.6, {-0.00, 0.02, 0}},--COM slide
    {6, 0.6, {0.000, 0.01, 0}},--Stabilize
  },
...
kick.def["kickOffLeftSyntethic"]={
  supportLeg = 1,
  def = {
     {1, 0.6, {-0.02,-0.050,0} , 0.303          }, --COM slide
     {2, 0.2, {-0.02,-0.050,0} , {-0.02,-0.02,0}, 0.01 , 0}, --Lifting
     {2, 0.1, {-0.02,-0.050,0} , {-0.02,0,0}, 0.04 , 20*math.pi/180},--Lifting
     {4, 0.2, {-0.03,-0.050,0} , { 0.25,0,0},  0.02 , 0*math.pi/180}, --Kicking
     {2, 0.2, {-0.03,-0.050,0} , {-0.11,0.005,0}, 0, 0 }, --Landing
     {2, 0.2, {-0.02,-0.050,0} , {-0.11,0.005,0}, 0, 0 }, --Landing
     {1, 0.5, {-0.00,-0.02, 0}},--COM slide
     {6, 0.5, {0.000,-0.01, 0}},--Stabilize
   },
}


kick.def["kickOffRightKarpet"]={
  supportLeg = 0,
  def = {
    {1, 0.6, {-0.02 ,0.045,0},0.303}, --COM slide
    {3, 0.2, {-0.02 ,0.045,0} , {-0.02, 0.02, 0}, 0.01 , 0},
    {3, 0.1, {-0.03 ,0.045,0} , {-0.02, 0, 0}, 0.04 , 20*math.pi/180},
    {5, 0.2, {-0.03 ,0.045,0} , {0.2, 0, 0},  0.02 , 0*math.pi/180},--Kicking
    {3, 0.2, {-0.02 ,0.045,0} , {-0.08,-0.005,0}, 0, 0 }, --Landing
    {3, 0.2, {-0.02 ,0.045,0} , {-0.09,-0.005,0}, 0, 0 }, --Landing
    {1, 0.6, {-0.00, 0.02, 0}},--COM slide
    {6, 0.6, {0.000, 0.01, 0}},--Stabilize
  },
}

kick.def["kickOffLeftKarpet"]={
  supportLeg = 1,
  def = {
     {1, 0.6, {-0.02,-0.050,0} , 0.303          }, --COM slide
     {2, 0.2, {-0.02,-0.050,0} , {-0.02,-0.02,0}, 0.01 , 0}, --Lifting
     {2, 0.1, {-0.03,-0.050,0} , {-0.02,0,0}, 0.04 , 40*math.pi/180},--Lifting
     {4, 0.2, {-0.03,-0.050,0} , {0.2,0,0}, 0.02 , 0*math.pi/180}, --Kicking
     {2, 0.2, {-0.02,-0.050,0} , {-0.08,0.005,0}, 0, 0 }, --Landing
     {2, 0.2, {-0.02,-0.050,0} , {-0.09,0.005,0}, 0, 0 }, --Landing
     {1, 0.6, {-0.00,-0.040, 0}},--COM slide
     {6, 0.6, {0.000, -0.01, 0}},--Stabilize
   },
}
]]--
